 <!-- End of Main Content -->
    ...
    <!-- Page level plugins -->
    <script src="<?= base_url(); ?>asset/backend/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<?= base_url(); ?>asset/backend/js/demo/chart-area-demo.js"></script>
    <script src="<?= base_url(); ?>asset/backend/js/demo/chart-pie-demo.js"></script>
